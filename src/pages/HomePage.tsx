    ...
    <Box>
      ...
      <Container size="lg">
        ...
        <Stack gap={isMobile ? 'md' : 'xl'} my={isMobile ? 'md' : 'xl'} align="center" >
          <Title c="green.8">Bienvenidos a EcoHarmony Park</Title>
        ...
        <Grid my={isMobile ? 'md' : 'xl'} gutter={isMobile ? 'sm' : 'md'}>
          <Grid.Col span={{ base: 12, md: 4 }}>
            <Card shadow="sm" bg="green.2">
              <Title order={3} c="green.7">Mapa Interactivo</Title>
              <Text c="green.6">
          ...
          <Grid.Col span={{ base: 12, md: 4 }}>
            <Card shadow="sm" bg="green.2">
              <Title order={3} c="green.7">Horarios de Alimentación</Title>
              <Text c="green.6">
          ...
          <Grid.Col span={{ base: 12, md: 4 }}>
            <Card shadow="sm" bg="green.2">
              <Title order={3} c="green.7">Compra de Entradas</Title>
              <Text c="green.6">
        ...
        <Stack align="center" my={isMobile ? 'md' : 'xl'} gap={isMobile ? 'md' : 'xl'}>
          <Title order={2} style={{ textAlign: 'center' }} c="green.8">Descarga Nuestra Aplicación</Title>
          <Text c="green.7">
